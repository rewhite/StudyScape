...
class XritWebViewDemo : MonoBehaviour {
    ...
    public GameObject webviewCanvas;
    ...
    {
        _canvasWebViewPrefab.WebView.LoadUrl(str);
    }
    
    public void SearchYoutube(string str)
    {
        _canvasWebViewPrefab.WebView.LoadUrl("https://www.youtube.com/results?search_query=" + str);
    }
